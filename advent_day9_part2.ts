console.log("advent_2023_day_9_part2")
...
//let tmp = numlines[2].reverse();
//let rec = recursiveGetNext(tmp);
//console.log(tmp, rec)


total = numlines.map((elem) => recursiveGetNext(elem.reverse())).reduce((acc, cv)=>{return acc + cv})
